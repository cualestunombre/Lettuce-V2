# [Lettuce-V2]
소프트웨어의 재사용성과 유지보수성을 높이는 것은 development에서 아주 중요한 요소임. 그러나, 
...
8. javascript및 html&css도 좀더 구조를 잡아 유지보수성을 높이고자 함. 
9. 최종적으로 서비스 객체에 대한 유닛테스트와 미들웨어(req,res)에 대한 통합테스트 커버리지 100%를 달성하고자 함. 

---------------------------------------------------------------------------------------------------------------------------------------------------


V3에서는 타입스크립트를 적용하여 좀 더 타입에 안전한 소프트웨어를 만들고, 단체 채팅기능을 구현할 예정임 
